...
public class AdminCategoriesController {
	...
	public String edit(@PathVariable int id, Model theModel) {
		...
		Category tempCategory = categoryRepository.getOne(id);
		
		theModel.addAttribute("category" , tempCategory);
	...
	@PostMapping("/edit")
	public String edit(@Valid Category category , BindingResult bindingResult , Model theModel , RedirectAttributes redirectAttributes ) {
		Category tempCategory = categoryRepository.getOne(category.getId());
	
		if(bindingResult.hasErrors()) {
			theModel.addAttribute("categoryName" , tempCategory.getName());
			return "admin/categories/edit";
		}
